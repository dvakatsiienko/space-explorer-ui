...
export type LaunchesKeySpecifier = (
    | 'cursor'
    | 'hasMore'
    | 'list'
    | LaunchesKeySpecifier
)[];
...
export type TripUpdateResponseKeySpecifier = (
    | 'launches'
    | 'message'
    | 'success'
    | TripUpdateResponseKeySpecifier
)[];
...
export type StrictTypedTypePolicies = {
    ...
    Launches?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
        keyFields?:
            | false
            | LaunchesKeySpecifier
            | (() => undefined | LaunchesKeySpecifier);
    ...
    TripUpdateResponse?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
        keyFields?:
            | false
            | TripUpdateResponseKeySpecifier
            | (() => undefined | TripUpdateResponseKeySpecifier);
